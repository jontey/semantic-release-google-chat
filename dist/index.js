 ...
 */
 var verifyConditions = async (pluginConfig, context) => {
  const { env } = context;
...
var marked_1 = createCommonjsModule(function (module, exports) {
...
const extractSections = (context) => {
  const html = marked_1.parse(context.nextRelease.notes);
  return html
};
...
var success = (pluginConfig, context) => {
...
var semanticReleaseGoogleChat = { verifyConditions, success };

module.exports = semanticReleaseGoogleChat;
